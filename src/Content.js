...
setNewCoinSend(coin,icon){
  this.setState({currentCoin:{crCoinY:icon,crTextY:coin}})
}
  render() {
    const cr = this.state;
    let cName = this.state.Coins;
    let searchSend = this.state.searchSend;
    cName = cName.filter(data =>{
  ...
  <div className="enginexchanger66548">
    ...
    <div className="form-row">
      <div className="input-group input-group-lg col-md-5">
        ...
        <div className="input-group-append">
          <a className="btn btn-secondary btnbord6565487" role="button"  data-toggle="dropdown">
            <i className={cr.currentCoin.crCoinY}></i>
            <span className="coin6549875">
              {cr.currentCoin.crTextY}<i className="fa fa-angle-down" aria-hidden="true"></i>
            </span>
          </a>
      ...
      <div className="input-group input-group-lg col-md-5">
        ...
        <div className="input-group-append">
          <a className="btn btn-secondary btnbord6565487" role="button" data-toggle="dropdown">
            <i className={cr.currentCoin.crCoinG}></i>
            <span className="coin6549875">
          ...
          <div className="dropdown-menu" aria-labelledby="dropdownMenuLink">
            ...
            <a className="dropdown-item">Something else here2</a>
          </div>
        </div>
      </div>
    </div>
